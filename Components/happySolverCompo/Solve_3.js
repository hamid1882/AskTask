...
export default function Solve_3({page, handleNextPage}) {
  return (
    <div className={page === 7 ? 'happy-container-inner-1-active' : 'happy-container-inner-1'}>
        <h2>Happy Solver</h2>
        ...
        <div className="login-bar">
            <button className="button" style={{textAlign: "center"}} onClick={() => handleNextPage("solution-3", 0)}>Done</button>
        </div>
        <style jsx>{`
        .happy-container {
          width: 100%;
